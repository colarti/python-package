...
setup(
  name = 'ecmo-invoicing-pdf',         #* Your package will have this name
  packages = ['Invoicing'],   #* Name the package again
  version = '0.0.1',         #* To be increased every time your change your library
  ...
  author = 'ECMO',                   # Your name
  author_email = 'learnpython407@gmail.com',  # Your email
